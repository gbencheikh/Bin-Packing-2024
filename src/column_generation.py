...
def pricing_problem_maxrects(superitems_pool, pallet_dims, duals):
    ...
    layer = utils.maxrects_single_layer_online(superitems_pool, pallet_dims, sduals)
...
def pricing_problem_placement_mr(superitems_pool, superitems_in_layer, pallet_dims):
    ...
    """
    start = time.time()
    layer = utils.maxrects_single_layer_offline(
        superitems_pool,
        pallet_dims,
...
def column_generation(
    ...
    final_layer_pool = utils.LayerPool(layer_pool.superitems_pool, pallet_dims)
